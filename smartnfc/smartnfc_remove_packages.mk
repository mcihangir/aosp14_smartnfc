...
PRODUCT_PACKAGES_REMOVE += BootAnimation bootanimation

# Remove Qualcomm test/log tools
PRODUCT_PACKAGES_REMOVE += \
    QCC-TR-UI \
    QLog_APP \
    UnifiedSensorTestApp

# Optional: Remove legacy media provider (no media scanning)
#PRODUCT_PACKAGES_REMOVE += MediaProviderLegacy